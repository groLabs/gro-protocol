...
async function investVaults(controller) {
  ...
  const lifeguard = controller.lifeguard;
  await DAIVaultAdaptor.setStrategyRatioBuffer(10000)
  await DAIVaultAdaptor.invest()
  await USDCVaultAdaptor.setStrategyRatioBuffer(10000)
  await USDCVaultAdaptor.invest()
  await USDTVaultAdaptor.setStrategyRatioBuffer(10000)
